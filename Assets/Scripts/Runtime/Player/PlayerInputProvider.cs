...
namespace Musashi
{
    ...
    public class PlayerInputProvider : MonoBehaviour
    {
        ...
        #region Player Move Properties :these depend on GameManager.Instance.CanProcess
        public Vector3 GetMoveInput
        {
            get
            {
                if (GameManager.Instance.CanProcessPlayerMoveInput)
                {
        ...
        public float GetLookInputHorizontal => GameManager.Instance.CanProcessPlayerMoveInput ? PlayerInputActions.Look.ReadValue<Vector2>().x : 0f;
        ...
        public bool Jump => GameManager.Instance.CanProcessPlayerMoveInput && PlayerInputActions.Jump.triggered;
        public bool Fire => GameManager.Instance.CanProcessPlayerMoveInput && PlayerInputActions.Fire.triggered;

        private bool heldFire;
        public bool HeldFire => GameManager.Instance.CanProcessPlayerMoveInput && heldFire;
        public bool Reload => GameManager.Instance.CanProcessPlayerMoveInput && PlayerInputActions.Reload.triggered;
        public bool Interactive => GameManager.Instance.CanProcessPlayerMoveInput && PlayerInputActions.InteractPickup.triggered;

        private bool aim;
        public bool Aim => GameManager.Instance.CanProcessPlayerMoveInput && aim;
        ...
        private void Awake()
        {
            ...
            PlayerInputActions.Crouch.started += ctx => CanCrouch = GameManager.Instance.CanProcessPlayerMoveInput ? !CanCrouch : CanCrouch;
